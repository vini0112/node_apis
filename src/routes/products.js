...
// sessao filtros
router.post('/filtroOleoSimples', upload.single('image'), productControllers.postEstruturaAplicacoes)
router.post('/filtroOleoPesado', upload.single('image'), productControllers.postEstruturaAplicacoes)
router.post('/filtroCombustSimples', upload.single('image'), productControllers.postEstruturaAplicacoes)
router.post('/filtroCombustPesado', upload.single('image'), productControllers.postEstruturaAplicacoes)
router.post('/filtroArMotor', upload.single('image'), productControllers.postEstruturaAplicacoes)
router.post('/filtroArCabine', upload.single('image'), productControllers.postEstruturaAplicacoes)
router.post('/mangoteAR', upload.single('image'), productControllers.postEstruturaAplicacoes)

// sessao direcao
router.post('/terminaisDirecao', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/barrasAxiais', upload.single('image'),productControllers.postBarrasAxiais)
router.post('/estabilizadores', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/BuchaCaixaDirecao', upload.single('image'),productControllers.postEstruturaAplicacoes)

// sessao suspensao
router.post('/batedores', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/pivos', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/amortecedores', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/buchaSusp', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/coxinsAmort', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/bieletas', upload.single('image'),productControllers.postEstruturaAplicacoes)

// sessao freios
router.post('/pastilhaFreio', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/discosFreio', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/sapatasFreio', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/cilindros', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/tamboresFreio', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/reparosFreio',upload.single('image'), productControllers.postEstruturaAplicacoes)
router.post('/cabosEflexiveis', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/acessoriosFreio', upload.single('image'),productControllers.postEstruturaAplicacoes)

// sessao ignicao
router.post('/cabosDvela', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/velas', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/bobinasIgnicao', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/modulosIgnicao', upload.single('image'),productControllers.postEstruturaAplicacoes)

// sessao carga
router.post('/tensoresCorreia', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/correiaAlternador', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/correiasDentada', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/reguladorVolt',upload.single('image'), productControllers.postEstruturaAplicacoes)
router.post('/estatores', upload.single('image'),productControllers.postEstruturaAplicacoes)

// sessao partida
router.post('/bendix', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/portaEscovas', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/acessoriosMotorPart', upload.single('image'),productControllers.postEstruturaAplicacoes)

// sessao arrefecimento
router.post('/bombasDgua', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/reservatorioDagua', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/valvulasTermo', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/eletroventiladores',upload.single('image'), productControllers.postEstruturaAplicacoes)
router.post('/canosDagua', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/tubosDagua', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/resistenciaEletro', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/diversasArrefeci', upload.single('image'),productControllers.postEstruturaAplicacoes)

// sessao injecao
router.post('/bicosInjecao', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/bombaCombust', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/flangeBombaCombust', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/acessoriosCombust', upload.single('image'),productControllers.postEstruturaAplicacoes)

// sessao transmissao
router.post('/discosEmbreagem', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/reparoCambioTrabulador', upload.single('image'),productControllers.postEstruturaAplicacoes)

// sessao rodagem
router.post('/cubosRoda', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/pontasEixo', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/juntasHomocinetica', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/rolamentosRoda', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/rolamentoDiversos', upload.single('image'),productControllers.postEstruturaAplicacoes)

// sessao escapes
router.post('/bojosTras', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/canosIntermediario', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/coxinsEscap', upload.single('image'),productControllers.postEstruturaAplicacoes)
router.post('/acessoriosEscap', upload.single('image'),productControllers.postEstruturaAplicacoes)
