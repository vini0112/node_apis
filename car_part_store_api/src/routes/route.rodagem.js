...
// get 
router.get('/cubosRoda', cubosRodaController.show)
router.get('/pontasEixo', pontasEixoController.show)
router.get('/juntasHomocinetica', homocineticasController.show)
router.get('/rolamentosRoda', rolamentosRodaController.show)
router.get('/rolamentoDiversos', rolamentosDiversosController.show)
