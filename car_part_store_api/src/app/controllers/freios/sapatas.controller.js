...
import sapatasRepository from "../../repositories/sessao-freios/sapatas.repository.js"

class sapatasController {
    async show(req, res){
        const row = await sapatasRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await sapatasRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await sapatasRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await sapatasRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await sapatasRepository.delete(id)
        res.json(row)
    }
