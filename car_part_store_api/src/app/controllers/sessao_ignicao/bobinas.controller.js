import bobinasRepository from "../../repositories/sessao-ignicao/bobinas.repository.js"


class bobinasController {
    async show(req, res){
        const row = await bobinasRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await bobinasRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await bobinasRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await bobinasRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await bobinasRepository.delete(id)
        res.json(row)
    }

}

export default new bobinasController()