...
// get
router.get('/terminaisDirecao', terminaisController.show)
router.get('/barrasAxiais', barrasAxiaisController.show)
router.get('/estabilizadores', estabilizadoresController.show)
router.get('/BuchaCaixaDirecao', buchaCaixaDirController.show)
