...
import cilindrosRepository from "../../repositories/sessao-freios/cilindros.repository.js"

class cilindrosController {
    async show(req, res){
        const row = await cilindrosRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await cilindrosRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await cilindrosRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await cilindrosRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await cilindrosRepository.delete(id)
        res.json(row)
    }

}

export default new cilindrosController()