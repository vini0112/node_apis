...
class pontaEixoRepository {
    ...
    findById(id){
        const sql = "SELECT * FROM pontas_eixo WHERE idpontas_eixo=?"
    ...
    editing(id, dados){
        let sql = "UPDATE pontas_eixo SET ? WHERE idpontas_eixo=?"
        return consulta(sql, [dados, id], 'Erro in Edit Product!')
    }

    delete(id){
        const sql = 'DELETE FROM pontas_eixo WHERE idpontas_eixo=?'
