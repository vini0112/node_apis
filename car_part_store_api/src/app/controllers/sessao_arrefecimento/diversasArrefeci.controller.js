import diversasArrefeRepository from "../../repositories/sessao-arrefecimento/diversasArrefe.repository.js"


class diversasArrefController {

    async show(req, res){
        const row = await diversasArrefeRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await diversasArrefeRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await diversasArrefeRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await diversasArrefeRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await diversasArrefeRepository.delete(id)
        res.json(row)
    }

}

export default new diversasArrefController()