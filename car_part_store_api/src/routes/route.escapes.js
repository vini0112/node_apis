...
// get 
router.get('/bojosTras', bojosController.show)
router.get('/canosIntermediario' , intermediariosController.show)
router.get('/coxinsEscap' , coxinsEscapesController.show)
router.get('/acessoriosEscap' , acessoriosEscapesController.show)
