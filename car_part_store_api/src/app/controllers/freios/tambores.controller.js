...
import tamboresRepository from "../../repositories/sessao-freios/tambores.repository.js"

class tamboresController {
    async show(req, res){
        const row = await tamboresRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await tamboresRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await tamboresRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await tamboresRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await tamboresRepository.delete(id)
        res.json(row)
    }

}

export default new tamboresController()