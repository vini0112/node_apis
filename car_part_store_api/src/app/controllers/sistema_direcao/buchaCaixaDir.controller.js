import buchaCaixaDirRepository from "../../repositories/sistema-direcao/buchaCaixaDir.repository.js"

class buchaCaixaDirController{

    async show(req, res){
        const row = await buchaCaixaDirRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await buchaCaixaDirRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await buchaCaixaDirRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await buchaCaixaDirRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await buchaCaixaDirRepository.delete(id)
        res.json(row)
    }

}

export default new buchaCaixaDirController()