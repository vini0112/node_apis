...
// get 
router.get('/bicosInjecao', bicosInjecaoController.show)
router.get('/bombaCombust', bombasCombustController.show)
router.get('/flangeBombaCombust', flangeBombaCombustController.show)
router.get('/acessoriosCombust', acessoriosCombustController.show)
