import valvulasTermoRepository from "../../repositories/sessao-arrefecimento/valvulasTermo.repository.js"

class valvulasTermoController {

    async show(req, res){
        const row = await valvulasTermoRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await valvulasTermoRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await valvulasTermoRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await valvulasTermoRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await valvulasTermoRepository.delete(id)
        res.json(row)
    }

}

export default new valvulasTermoController()