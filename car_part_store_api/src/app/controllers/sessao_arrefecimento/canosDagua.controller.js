import canosDaguaRepository from "../../repositories/sessao-arrefecimento/canosDagua.repository.js"


class canosdaguaController {

    async show(req, res){
        const row = await canosDaguaRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await canosDaguaRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await canosDaguaRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await canosDaguaRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await canosDaguaRepository.delete(id)
        res.json(row)
    }

}

export default new canosdaguaController()