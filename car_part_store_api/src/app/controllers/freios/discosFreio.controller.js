...
import discosFreioRepository from "../../repositories/sessao-freios/discosFreio.repository.js"

class discosFreioController {
    async show(req, res){
        const row = await discosFreioRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await discosFreioRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await discosFreioRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await discosFreioRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await discosFreioRepository.delete(id)
        res.json(row)
    }

}

export default new discosFreioController()