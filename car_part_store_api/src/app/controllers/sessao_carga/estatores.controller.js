import estatoresRepository from "../../repositories/sessao-carga/estatores.repository.js"


class estatoresController {

    async show(req, res){
        const row = await estatoresRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await estatoresRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await estatoresRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await estatoresRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await estatoresRepository.delete(id)
        res.json(row)
    }

}

export default new estatoresController()