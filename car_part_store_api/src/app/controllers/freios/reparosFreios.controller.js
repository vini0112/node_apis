...
import reparosFreiosRepository from "../../repositories/sessao-freios/reparosFreios.repository.js"

class cabosFreioController {
    async show(req, res){
        const row = await reparosFreiosRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await reparosFreiosRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await reparosFreiosRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await reparosFreiosRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await reparosFreiosRepository.delete(id)
        res.json(row)
    }

}

export default new cabosFreioController()