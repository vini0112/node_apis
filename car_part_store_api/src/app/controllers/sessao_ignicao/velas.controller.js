import velasRepository from "../../repositories/sessao-ignicao/velas.repository.js"


class velasController {

    async show(req, res){
        const row = await velasRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await velasRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await velasRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await velasRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await velasRepository.delete(id)
        res.json(row)
    }

}

export default new velasController()