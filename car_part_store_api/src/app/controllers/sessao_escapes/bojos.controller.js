import bojosRepository from "../../repositories/sessao-escapes/bojos.repository.js"


class bojosController {

    async show(req, res){
        const row = await bojosRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await bojosRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await bojosRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await bojosRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await bojosRepository.delete(id)
        res.json(row)
    }

}

export default new bojosController()