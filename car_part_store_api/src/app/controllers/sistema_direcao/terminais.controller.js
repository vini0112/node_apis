...
import terminaisRepository from "../../repositories/sistema-direcao/terminais.repository.js"

class terminaisController{

    async show(req, res){
        const row = await terminaisRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await terminaisRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await terminaisRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await terminaisRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await terminaisRepository.delete(id)
        res.json(row)
    }
