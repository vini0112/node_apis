...
import mangotesArRepository from "../../repositories/sessao-filtros/mangotesAr.repository.js"

class mangotesArController{

    async show(req, res){
        const row = await mangotesArRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await mangotesArRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await mangotesArRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await mangotesArRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await mangotesArRepository.delete(id)
        res.json(row)
    }

}

export default new mangotesArController()