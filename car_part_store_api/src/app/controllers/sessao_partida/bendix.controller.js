import bendixRepository from "../../repositories/sessao-partida/bendix.repository.js"


class bendixController {

    async show(req, res){
        const row = await bendixRepository.findAll()
        res.json(row)
    }
    ...
    async showById(req, res){
        ...
        const row = await bendixRepository.findById(id)
        res.json(row)
    }
    ...
    async postando(req, res){
        ...
        const row = await bendixRepository.posting(dados)
        res.json(row)
    }
    ...
    async update(req, res){
        ...
        const row = await bendixRepository.editing(id, dados)
        res.json(row)
    }
    ...
    async deleting(req, res){
        const id = req.params.id
        const row = await bendixRepository.delete(id)
        res.json(row)
    }

}

export default new bendixController()